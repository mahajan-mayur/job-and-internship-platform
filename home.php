    ...
    <header id="header">
        <div class="container-fluid">
            ...
            <div id="logo" class="pull-left">
                <h1><a href="index.html" class="scrollto greenlink">Welecome to Job and Internship Listing</a></h1>
            ...
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active">
                        <div class="carousel-background"><img src="./images/pro3.jpeg" alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2>Jobs & Internships</h2>
                                <p>This is dummy information</p>
                                <a href="project3.html" class="btn-get-started scrollto">Get Started</a>
                            </div>
                        </div>
                    </div>
