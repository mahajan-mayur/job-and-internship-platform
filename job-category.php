...
$sql = "SELECT job_tittle, cat, pos, sal, dtd, abt, id  FROM company";
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="project3.html" class="scrollto greenlink">Jobs </a></h1>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        ?>
                         ...
                         <?php   echo "<td><a href='viewjob.php?id=".$row['id']."'>View Job</td>"; ?>
